...
// Your code goes here:
    ...
    void print(Vector<I, Is...> a) {
        std::cout << I << ' ';
        print(Vector<Is...>{});
    }

    template <int I>
    void print(Vector<I> a) {
        std::cout << I << '\n';
    }
...
// Your code goes here:
    ...
    template <int I, int U, int... Is>
    struct RemoveFirst<I, Vector<U, Is...>> {
        using type = typename Prepend<U, typename RemoveFirst<I, Vector<Is...>>::type>::type;
    };

    template <int I, int... Is>
    struct RemoveFirst<I, Vector<I, Is...>> {
        using type = Vector<Is...>;
    };

    template <int I>
    struct RemoveFirst<I, Vector<>> {
        using type = Vector<>;
    };
// ^ Your code goes here

    static_assert(std::is_same_v<RemoveFirst<1, Vector<1,1,2>>::type, Vector<1,2>>);
    static_assert(std::is_same_v<RemoveFirst<1, Vector<2>>::type, Vector<2>>);
...
// Your code goes here:
    ...
    template <int I>
    struct RemoveAll<I, Vector<>> {
        using type = Vector<>;
    };

    template <int I, int... Is>
    struct RemoveAll<I, Vector<I, Is...>> {
        using type = typename RemoveAll<I, Vector<Is...>>::type;
    };

    template <int I, int U, int... Is>
    struct RemoveAll<I, Vector<U, Is...>> {
        using type = typename Prepend<U, typename RemoveAll<I, Vector<Is...>>::type>::type;
    };
...
// Your code goes here:
    ...
    struct Length<Vector<I, Is...>> {
        constexpr static int value = 1 + Length<Vector<Is...>>::value;
    };
...
// Your code goes here:
    template <typename T>
    constexpr static int length = Length<T>::value;
// ^ Your code goes here
...
// Your code goes here:
    ...
    struct Sort<Vector<Is...>> {
        ...
        using helper = RemoveFirst<value, Vector<Is...>>::type;
        using type = typename Prepend<value, typename Sort<helper>::type>::type;
    };
